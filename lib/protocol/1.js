 ...
 * @returns {ProtocolStream}
 * @api private
 */

Protocol.prototype.createStream = function createStream (limit) {
  var stream = new ProtocolStream(this, limit);
  return stream;
};
...
/**
 * The protocol version for this parser.
 */

Protocol.version = 1;

/**
 * Expose the ProtocolStream.
 */

Protocol.ProtocolStream = ProtocolStream;
